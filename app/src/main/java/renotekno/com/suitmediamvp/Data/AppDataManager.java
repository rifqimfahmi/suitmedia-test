...
public class AppDataManager implements DataManager {
    ...
    public static final Event[] events = {
            ...
            new Event("Google Launchpad", new Date(1515139200000L), R.drawable.event_gdl, new String[]{"launchpad-id", "startup"}),
            new Event("Microsoft Ignite", new Date(1519891200000L), R.drawable.event_microsoft_ignite, new String[]{"microsoft", "ignite"}),
    };
